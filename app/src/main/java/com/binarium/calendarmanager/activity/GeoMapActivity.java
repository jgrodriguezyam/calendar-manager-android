...
public class GeoMapActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void initFragment() {
        ...
        Fragment geoMapFragment = GeoMapFragment.newInstance();
        fragmentTransaction.add(R.id.frame_container, geoMapFragment);
        fragmentTransaction.commit();
    }

    private void configureActionBar(){
        toolbar.setTitle(R.string.title_geo_map_activity);
